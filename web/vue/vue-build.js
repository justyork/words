...
},{"./vue.common.dev.js":9,"./vue.common.prod.js":11,"_process":3}],11:[function(require,module,exports){
(function (global,setImmediate){
/*!
 * Vue.js v2.6.10
 * (c) 2014-2019 Evan You
...
},{"timers":4}],12:[function(require,module,exports){
;(function(){
'use strict';
    ...
    methods: {
        getWords: function getWords() {
            ...
            this.$http.get(this.apiUrl + 'words-by-pack?id=' + this.pack_id).then(function (response) {
                if (response.status) _this.words = response.body;
            });
        },
        swipeHandler: function swipeHandler(direction) {
            console.log(direction);
            if (direction === 'left') this.next();else this.prev();
        },
        prev: function prev() {
            if (this.activeNum === 0) this.activeNum = this.words.length - 1;else this.activeNum--;
        },
        next: function next() {
            if (this.activeNum === this.words.length - 1) this.activeNum = 0;else this.activeNum++;
        },
        skip: function skip() {
            var _this2 = this;
            ...
            this.$http.post(this.apiUrl + 'skip-word', data).then(function (response) {
                if (response.status) {
                    console.log(response.data);
                    console.log(_this2.activeNum);
                    _this2.words[_this2.activeNum] = response.data;
                    var oldNum = _this2.activeNum;
                    _this2.activeNum = 0;
                    _this2.activeNum = oldNum;
                }
            });
        },
        saveTip: function saveTip() {
            ...
            this.$http.post(this.apiUrl + 'add-word-tip', data).then(function (response) {
                if (response.status) {
                    _this3.tipForm = false;
                    _this3.words[_this3.activeNum].tip = _this3.tipText;
                }
            });
        }
    },
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"touch",rawName:"v-touch:swipe",value:(_vm.swipeHandler),expression:"swipeHandler",arg:"swipe"}],staticClass:"learn"},[_c('div',{staticClass:"learn-tip"},[(!_vm.tipForm)?_c('a',{attrs:{"href":"javascript:;"},on:{"click":function($event){_vm.tipForm = true}}},[_vm._v("Add tip")]):_vm._e(),_vm._v(" "),(_vm.tipForm)?_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.tipText),expression:"tipText"}],attrs:{"type":"text"},domProps:{"value":(_vm.tipText)},on:{"input":function($event){if($event.target.composing){ return; }_vm.tipText=$event.target.value}}}),_vm._v(" "),_c('button',{on:{"click":_vm.saveTip}},[_vm._v("OK")])]):_vm._e()]),_vm._v(" "),(_vm.words.length)?_c('div',{staticClass:"learn__item"},[_c('div',{staticClass:"learn__item-word"},[_vm._v("\n            "+_vm._s(_vm.words[_vm.activeNum].word)+"\n        ")]),_vm._v(" "),_c('div',{staticClass:"learn-skip"},[_c('a',{staticClass:"ui mini blue button ",attrs:{"href":"javascript:;"},on:{"click":_vm.skip}},[_vm._v("Skip")])]),_vm._v(" "),_c('div',{staticClass:"learn__item-translate"},[_vm._v("\n            "+_vm._s(_vm.words[_vm.activeNum].translate)+"\n        ")]),_vm._v(" "),_c('div',{staticClass:"learn__item-tip"},[_vm._v("\n            "+_vm._s(_vm.words[_vm.activeNum].tip)+"  \n        ")])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"learn-button"},[_c('div',{staticClass:"learn-button__know fluid ui buttons"},[_c('a',{staticClass:"ui massive blue button",attrs:{"href":"javascript:;"},on:{"click":_vm.prev}},[_vm._v("PREV")]),_vm._v(" "),_c('a',{staticClass:"ui massive teal button",attrs:{"href":"javascript:;"},on:{"click":_vm.next}},[_vm._v("NEXT")])])])])}
...
module.exports = {
    ...
    methods: {
        seriesStat: function seriesStat(model) {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"margin-bottom":"3px"}},[_c('a',{class:'ui ' + (_vm.isRepeat ? 'blue' : (_vm.unlearned_words > 0 ? 'blue' : 'green')) +' button',staticStyle:{"width":"165px"},attrs:{"href":_vm.check_link}},[_vm._v("\n        "+_vm._s(_vm.label)+"\n    ")]),_vm._v(" "),_c('div',{staticStyle:{"display":"inline-block","margin-top":"5px"}},[_c('span',{staticClass:"ui  buttons"},[_c('a',{staticClass:"ui blue basic button icon",attrs:{"href":_vm.learn_link+'ab'+_vm.afterLink}},[_c('i',{staticClass:"arrow down icon"})]),_vm._v(" "),_c('a',{staticClass:"ui blue basic button icon",attrs:{"href":_vm.learn_link+'ba'+_vm.afterLink}},[_c('i',{staticClass:"arrow up icon"})]),_vm._v(" "),_c('a',{staticClass:"ui teal button icon",attrs:{"href":_vm.learn_link+'r'+_vm.afterLink}},[_c('i',{staticClass:"shuffle icon"})])]),_vm._v(" "),_c('span',{staticClass:"ui buttons"},[(_vm.can_select)?_c('button',{class:'ui toggle button icon pack-row '+(_vm.isSelect ? 'active' : ''),on:{"click":_vm.toggleRow}},[_c('i',{staticClass:"check icon"})]):_vm._e(),_vm._v(" "),_c('button',{class:'ui toggle button icon ' +(_vm.isRepeat ? 'active' : ''),on:{"click":_vm.changeRepeat}},[_c('i',{staticClass:"retweet icon"})])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
