...
},{"./_descriptors":11,"./_fails":15,"./_iobject":20,"./_object-gops":25,"./_object-keys":27,"./_object-pie":28,"./_to-object":36}],24:[function(require,module,exports){
...
},{"process/browser.js":41,"timers":42}],43:[function(require,module,exports){
var Vue // late bind
var version
...
},{"got":2}],46:[function(require,module,exports){
/**
 *
 * @author    Jerry Bendy
 * @since     4/12/2017
...
},{"timers":42}],48:[function(require,module,exports){
(function (process){
...
},{"./vue.common.dev.js":47,"./vue.common.prod.js":49,"_process":41}],49:[function(require,module,exports){
(function (global,setImmediate){
/*!
 * Vue.js v2.6.10
 * (c) 2014-2019 Evan You
...
},{"timers":42}],50:[function(require,module,exports){
...
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".learn-nav{\n    width: 100%;\n    display: flex;\n    margin: 20px 0;\n}\n.learn-nav a{\n    flex: 1;\n    text-align: center;\n    padding: 10px;\n    background: #c9c9c9;\n    color: white;\n    border-right: 1px solid white;\n}\n.learn-nav a:last-child{\n    border-right: none;\n}\n\n.learn-skip{\n    position: absolute;\n    margin-top: 10px;\n    padding: 0 !important;\n}\n.learn-skip a{\n    font-size: 14px;\n    color: black;\n}")
;(function(){
'use strict';
...
},{"vue":48,"vue-hot-reload-api":43,"vueify/lib/insert-css":50}],52:[function(require,module,exports){
...
module.exports = {
    ...
    computed: {
        word: function word() {
            if (this.type == 'ab') return this.words[0].word;
            if (this.type == 'ba') return this.words[0].translate;
            if (this.type == 'r') {
                return this.words[0].word;
            }
        },
        translate: function translate() {
            if (this.type == 'ab') return this.words[0].translate;
            if (this.type == 'ba') return this.words[0].word;
            if (this.type == 'r') {
